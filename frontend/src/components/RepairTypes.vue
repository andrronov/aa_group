...
const types = [
  {
    ...
    img: ["images/apartment.png", "images/apartment.png"],
    description:
  ...
  {
    label: "Ремонт домов",
    img: ["images/house.jpg", "images/apartment.png"],
    description:
  ...
  {
    label: "Ремонт офисов",
    img: ["images/ofice.jpg", "images/apartment.png"],
    description:
  ...
  },
  {
    ...
    img: ["images/by-key.jpg", "images/apartment.png"],
    description:
      "Берём на себя весь процесс — от разработки проекта до последнего штриха. Мы выполняем все виды работ: черновая отделка, инженерные коммуникации, финишная отделка и декор. Контролируем каждую деталь, чтобы вы получили идеальный результат без лишних забот. Ремонт, которым можно просто наслаждаться.",
  },
  {
    label: "Поэтапный ремонт",
    img: ["images/by-step.jpg", "images/apartment.png"],
    description:
